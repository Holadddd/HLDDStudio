...
extension DrumMachineViewController: GridViewDataSource {
    ...
    func gridView(_ gridView: GridView,
                  numberOfRowsInColumn column: Int) -> Int {
    ...
    func gridView(_ gridView: GridView,
                  widthForColumn column: Int) -> CGFloat {
    ...
    func gridView(_ gridView: GridView,
                  cellForRowAt indexPath: IndexPath) -> GridViewCell {
        ...
        case drumMachineView.drumEditingGridView:
            ...
            if DrumMachineManger.manger.isPortrait {
                ...
                guard let vCell = gridView
                    .dequeueReusableCell(withReuseIdentifier: String(describing: DrumEditingGridViewCell.self ),
                                         for: indexPath)
                    as? DrumEditingGridViewCell
                    else { fatalError() }
                
                let type = patterInfo.drumType
                ...
                case .classic:
                    ...
                    vCell.typeTextField.text = DrumMachineManger.manger.drumTypeStringArr[type.rawValue]
                ...
                guard let hCell = gridView
                    .dequeueReusableCell(
                    withReuseIdentifier: String(describing: DrumEditingHorizontalGridViewCell.self),
                                                               for: indexPath)
                    as? DrumEditingHorizontalGridViewCell
                    else { fatalError() }
        ...
        case drumMachineView.drumBarGridView:
            ...
            guard let cell = gridView
                .dequeueReusableCell(
                    withReuseIdentifier: String(describing: DrumBarGridViewCell.self),
                    for: indexPath)
                as? DrumBarGridViewCell
                else { fatalError() }
            ...
            case 0:
                ...
                cell.backgroundColor = UIColor.hexStringToUIColor(
                    hex: DrumMachinePatternBackgroundColor.firstSec.rawValue)
            case 1:
                
                cell.backgroundColor = UIColor.hexStringToUIColor(
                    hex: DrumMachinePatternBackgroundColor.secondSec.rawValue)
            case 2:
                
                cell.backgroundColor = UIColor.hexStringToUIColor(
                    hex: DrumMachinePatternBackgroundColor.thirdSec.rawValue)
            case 3:
                
                cell.backgroundColor = UIColor.hexStringToUIColor(
                    hex: DrumMachinePatternBackgroundColor.fourthSec.rawValue)
            default:
        ...
        case drumMachineView.drumPatternGridView:
            ...
            if DrumMachineManger.manger.isPortrait {
                ...
                guard let vCell = gridView
                    .dequeueReusableCell(
                        withReuseIdentifier: "DrumPatternGridViewCell",
                        for: indexPath)
                    as? DrumPatternGridViewCell
                    else { fatalError() }
                ...
                guard let hCell = gridView
                    .dequeueReusableCell(
                        withReuseIdentifier: String(describing: DrumPatternHorizontalGridViewCell.self),
                        for: indexPath)
                    as? DrumPatternHorizontalGridViewCell
                    else { fatalError() }
