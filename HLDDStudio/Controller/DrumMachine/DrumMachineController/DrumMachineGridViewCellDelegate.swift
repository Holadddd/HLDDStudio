...
extension DrumMachineViewController: DrumEditingGridViewCellDelegate {
    ...
    func changDrumType(cell: GridViewCell,
                       drumType: DrumType) {
        
        let row = cell.indexPath.row
        
        DrumMachineManger.manger.changeDrumType(atRow: row,
                                                drumType: drumType)
    }
    ...
    func panValueChange(cell: GridViewCell,
                        value: Float) {
    ...
    func volumeValueChange(cell: GridViewCell,
                           value: Float) {
    ...
    func changeDrumSample(cell: GridViewCell,
                          drumType: DrumType,
                          sampleIndex: Int) {
        
        let row = cell.indexPath.row
        
        DrumMachineManger.manger.changeDrumSample(atRow: row,
                                                  withType: drumType,
                                                  fileIndex: sampleIndex)
    }
}
...
extension DrumMachineViewController: DrumPatternGridViewCellDelegate {
    ...
    func patternSelected(cell: GridViewCell,
                         isSelected: Bool) {
