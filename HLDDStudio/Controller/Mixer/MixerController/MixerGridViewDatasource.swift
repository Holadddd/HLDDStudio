...
extension ViewController: GridViewDataSource {
    ...
    func gridView(_ gridView: GridView,
        ...
        case 0:
            ...
            guard let cell = mixerView
                .trackGridView
                .dequeueReusableCell(withReuseIdentifier: String(describing: IOGridViewCell.self),
                                                                         for: indexPath)
                as? IOGridViewCell
                else { fatalError() }
        ...
        case 1:
            ...
            guard let cell = mixerView
                .trackGridView
                .dequeueReusableCell(withReuseIdentifier: String(describing: PlugInGridViewCell.self),
                                     for: indexPath)
        ...
        case 2:
            ...
            guard let cell = mixerView
                .trackGridView
                .dequeueReusableCell(withReuseIdentifier: String(describing: FaderGridViewCell.self),
                                     for: indexPath)
                as? FaderGridViewCell
                else { fatalError() }
